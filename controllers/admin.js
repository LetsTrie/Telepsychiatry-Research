...
exports.approveResearch = async(req, res) => {
    ...
    ResearchModel.updateOne({ _id: id }, { $set: { isVerified: true } }, (err, docs) => {
...
exports.disapproveResearch = async(req, res) => {
    const id = req.params.id
    ResearchModel.updateOne({ _id: id }, { $set: { isVerified: false } }, (err, docs) => {
        res.redirect('/admin/get_research')
    })
}
...
exports.approveInnovation = async(req, res) => {
    const id = req.params.id
    console.log('approve')
    InnovationModel.updateOne({ _id: id }, { $set: { isVerified: true } }, (err, docs) => {
...
exports.disapproveInnovation = async(req, res) => {
    const id = req.params.id
    InnovationModel.updateOne({ _id: id }, { $set: { isVerified: false } }, (err, docs) => {
